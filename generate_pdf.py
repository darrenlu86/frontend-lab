...
OUTPUT = os.path.join(os.path.dirname(__file__), "20250413_\u96fb\u5b50\u559c\u5e16\u8207\u611f\u8b1d\u5361\u7247 \u63d0\u6848\u8207\u5831\u50f9\u55ae.pdf")
...
def build_pdf():
    ...
    pdf.body_text("\u52a0\u8cfc\u9805\u76ee", bold=True)
    pdf.simple_table(
        ["\u9805\u76ee", "\u8aaa\u660e", "\u52a0\u50f9"],
        [
            ["\u524d\u5f8c\u7aef\u5206\u96e2", "\u8cd3\u5ba2\u8cc7\u6599\u6539\u7531\u5f8c\u7aef\u7ba1\u7406\uff0c\u4e0d\u76f4\u63a5\u66b4\u9732\u65bc\u524d\u7aef\u7a0b\u5f0f\u78bc", "+NT$ 1,500"],
            ["\u81ea\u8a02\u7db2\u57df", "\u7d81\u5b9a\u500b\u4eba\u7db2\u57df\uff0c\u8cbb\u7528\u4f9d\u7db2\u57df\u5546\u5831\u50f9", "\u4ee3\u8cfc\u5be6\u5831\u5be6\u92b7"],
        ],
        [40, 105, 45],
    )
    pdf.note_text(
        "\u5099\u8a3b\uff1a\u57fa\u672c\u5831\u50f9\u4ee5\u7d14\u975c\u614b\u7db2\u7ad9\u70ba\u4e3b\uff0c\u8cd3\u5ba2\u8cc7\u6599\u76f4\u63a5\u5b58\u653e\u65bc\u524d\u7aef\u3002"
        "\u82e5\u6709\u96b1\u79c1\u9700\u6c42\uff08\u5982\u4e0d\u5e0c\u671b\u8cd3\u5ba2\u8cc7\u6599\u53ef\u88ab\u6aa2\u8996\uff09\uff0c\u5efa\u8b70\u52a0\u8cfc\u524d\u5f8c\u7aef\u5206\u96e2\u65b9\u6848\u3002"
    )
    ...
    pdf.simple_table(
        ...
        [
            ...
            ["\u9069\u7528\u6d41\u91cf", "\u4e00\u822c\u5a5a\u79ae\u4f7f\u7528\u898f\u6a21\uff0c\u5982\u56e0\u7570\u5e38\u6d41\u91cf\u5c0e\u81f4\u8d85\u984d\u8cbb\u7528\uff0c\u7531\u7532\u65b9\u8ca0\u64d4"],
    ...
    pdf.bullet("\u7532\u65b9\u4eab\u6709\u8a72\u7db2\u9801\u4e4b\u6c38\u4e45\u4f7f\u7528\u6b0a\uff08\u9650\u672c\u6b21\u5a5a\u79ae\u7528\u9014\uff09", 15)
